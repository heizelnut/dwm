...
static const char *fonts[]          = { "FontAwesome:size=10", "Iosevka Nerd Font Mono:size=12:style=Oblique" };
static const char dmenufont[]       = "Iosevka Nerd Font Mono:size=12:style=Oblique";
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", black, "-nf", lightgray, "-sb", darkgray, "-sf", white, NULL };
